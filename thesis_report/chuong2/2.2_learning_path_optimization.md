...
trong đó $L^{\text{opt}}$ là lời giải tối ưu được lưu lại cho cấu hình con (i-1, b - cost). Do gain phụ thuộc vào toàn bộ tập $L$ đã chọn (không phải chỉ skill cuối thêm vào), DP cần lưu trữ trạng thái là *tập* các skill đã chọn, không chỉ index và budget — dẫn đến độ phức tạp $O(2^{|V|})$.
