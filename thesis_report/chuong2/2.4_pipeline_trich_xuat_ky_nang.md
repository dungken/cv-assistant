...
> **Lưu ý:** Mục này mô tả cơ sở lý thuyết cho thành phần **Skill Extraction & Matching Pipeline** — infrastructure tiền xử lý CV/JD cho hai đóng góp khoa học chính của đề tài (Multi-criteria Freshness, Market Intel). Pipeline không phải là đóng góp khoa học chính nhưng là nền tảng kỹ thuật cần thiết, được trình bày đầy đủ ở Chương 3 (thiết kế) và Chương 4 (thực nghiệm).
...
3. **Mô tả các quan hệ** giữa các kỹ năng — bốn loại: **REQUIRES** (A là tiên quyết của B, ví dụ React REQUIRES JavaScript), **LEADS_TO** (học A thường dẫn đến B, ví dụ JavaScript LEADS_TO React), **RELATED_TO** (cùng ecosystem hoặc có thể thay thế, React RELATED_TO Vue.js), **PART_OF** (thành phần của một cụm lớn hơn, React PART_OF Frontend Development).
4. **Lưu metadata** cho mỗi canonical: domain, category, aliases.

**Skill Ontology cho thị trường CNTT Việt Nam.** Hai bộ ontology quốc tế phổ biến là ESCO [[14]](../tai_lieu_tham_khao.md#ref-14) (~13.890 kỹ năng, 27 ngôn ngữ châu Âu) và O*NET [[15]](../tai_lieu_tham_khao.md#ref-15) (~16.000 kỹ năng, ~1.110 nghề nghiệp tại Mỹ) đều không hỗ trợ tiếng Việt và không phản ánh đầy đủ thực trạng thị trường CNTT Việt Nam (alias đặc thù, công nghệ cập nhật sau 2022). Đề tài tự xây dựng ontology IT **460 entries thuộc 15 category** cho domain CNTT Việt Nam.

**Vai trò trong hệ thống.** Skill Ontology được dùng làm input cho hai chiều của Multi-criteria CV Freshness Framework: (i) chiều **Skill** — tính importance weight $w_r(s)$ qua các cạnh PART_OF/REQUIRES; (ii) chiều **Market Alignment** — chuẩn hóa skill text trên cả CV và JD về cùng canonical để so sánh.
...
**Kết luận về vai trò của Cascade Matching.** Cascade Matching là phần cốt lõi của pipeline tiền xử lý, đảm bảo input chất lượng cao cho hai đóng góp khoa học chính: Multi-criteria Freshness (dùng skill canonical để tính Skill dimension) và Market Intel (dùng skill canonical để aggregate thị trường). Pipeline được đánh giá đa tầng — span-level F1 NER per-entity trên 100 CV + end-to-end Cascade Matching trên test suite — chi tiết kết quả thực nghiệm được trình bày trong Chương 4.

---

[← 2.3 Web Crawling](./2.3_web_crawling.md) | [→ 2.5 Công nghệ và công cụ](./2.5_cong_nghe_cong_cu.md)
