...
Sau khi cài đặt cả ba thuật toán theo thiết kế ở các mục 3.3.2–3.3.3 và chạy trên bộ 50 test case mô tả ở 3.3.4, kết quả benchmark sơ bộ như sau (chi tiết kỹ thuật và phân tích sẽ được trình bày trong Chương 4 sau khi có đủ dữ liệu user study).
...
Báo cáo benchmark đầy đủ và phân tích trên user study sẽ được trình bày trong [Chương 4](#).
