...
## 3.4.3 Deduplication — hai tầng `jd_key` và `job_group_id`

Trong dữ liệu JD crawl, có ba mức trùng lặp cần phân biệt và xử lý khác nhau (đã phân tích trong [mục 2.3.2](../chuong2/2.3_market_intelligence.md#232-cross-source-deduplication-bài-toán-và-giải-pháp-hash-based)):
...
[← 3.3 Thiết kế Learning Path Optimizer](./3.3_thiet_ke_learning_path_optimizer.md) | [→ 3.5 Thiết kế Market Intelligence Dashboard](./3.5_thiet_ke_market_intel.md)
