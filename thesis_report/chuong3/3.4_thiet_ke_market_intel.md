# 3.5 Thiết kế Market Intelligence Dashboard

## 3.5.1 Vai trò trong hệ thống

Market Intelligence Dashboard (gọi tắt **Market Intel**) là đóng góp khoa học chính số 3 của đề tài — tầng trình bày dữ liệu thị trường tuyển dụng CNTT Việt Nam. Khác với CV Health Dashboard (trình bày trong [mục 3.7](./3.7_thiet_ke_kien_truc.md)) tập trung vào trạng thái cá nhân của người dùng, Market Intel cung cấp **bức tranh vĩ mô** giúp sinh viên đối chiếu CV của mình với mặt bằng chung của thị trường:
...
Market Intel **không cá nhân hóa** — mọi người dùng truy cập đều thấy cùng dữ liệu. Việc cá nhân hóa thuộc về CV Health Dashboard.
...
## 3.5.3 Nguyên tắc thiết kế

Market Intel áp dụng các nguyên tắc dashboard của Few (2006) [[9]](../tai_lieu_tham_khao.md#ref-9) (đã trình bày trong [mục 2.3.3](../chuong2/2.3_market_intelligence.md#233-information-dashboard-design-cho-thị-trường-tuyển-dụng)), bổ sung thêm ba nguyên tắc riêng cho **analytics dashboard**:
...
## 3.5.5 Thuật toán & xử lý dữ liệu
...
[← 3.4 Pipeline crawl JD + cross-source dedup](./3.4_thiet_ke_pipeline_crawl.md) | [→ 3.6 Skill Extraction & Matching Pipeline](./3.6_thiet_ke_skill_extraction_pipeline.md)
