...
Một trong những rào cản lớn nhất là **sự thiếu hụt công cụ hỗ trợ thông minh bằng tiếng Việt**: các hệ thống ATS (Applicant Tracking System) phổ biến trên thị trường chủ yếu được tối ưu cho tiếng Anh, trong khi CV tiếng Việt có cấu trúc và từ vựng đặc thù riêng [[1]](tai_lieu_tham_khao.md#ref-1). Bên cạnh đó, ứng viên thường không có đủ thông tin để tự đánh giá mức độ phù hợp (ATS score) giữa CV của mình và yêu cầu từ nhà tuyển dụng.

Xử lý ngôn ngữ tự nhiên (NLP) và các mô hình ngôn ngữ lớn (LLM) đã chứng minh hiệu quả vượt trội trong các bài toán hiểu ngữ nghĩa văn bản [[2]](tai_lieu_tham_khao.md#ref-2). Đặc biệt, mô hình PhoBERT [[3]](tai_lieu_tham_khao.md#ref-3) — mô hình BERT tiền huấn luyện đầu tiên cho tiếng Việt — đã đạt kết quả state-of-the-art trên nhiều tác vụ NLP tiếng Việt, mở ra cơ hội ứng dụng vào bài toán phân tích CV/JD tiếng Việt.
