...
**Cơ chế gốc rễ của vấn đề.** Silver labels được tạo bằng rule-based annotator hoạt động ở cấp độ _word_ — phân tách text theo khoảng trắng, rồi khớp từng từ với dictionary để gán nhãn BIO. Trong khi đó, mBERT [[33]](../tai_lieu_tham_khao.md#ref-33) dùng WordPiece tokenizer chia nhỏ từ thành _subword_ — mỗi từ có thể thành 2–5 subword token. Hai hệ thống này tạo ra chuỗi token có độ dài và ranh giới hoàn toàn khác nhau trên cùng một văn bản, khiến việc so sánh nhãn trực tiếp là vô nghĩa.
